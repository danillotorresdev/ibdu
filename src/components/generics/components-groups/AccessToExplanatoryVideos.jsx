...
import ScrollBarWithCards from '../components-groups/ScrollBarWithCards'
...
export default class AccessToExplanatoryVideos extends Component {
    state = {
        "videoExplicativo": [],
        "id_do_video": '',
        'thumbVideo': '',
        ...
        return (
            <Section classSection='accessToExplanatoryVideos'>
                <Container>
                    ...
                    <div className="row">
                        <div className='col-lg-6 mb-3 accessToExplanatoryVideos--videoRendered'>
                                ...
                                {this.state.videoExplicativo.map(videoExplicativo =>
                                    <div className="LinkVideo" onClick={() => this.handleClickOnVideo(videoExplicativo)}>
                                        <CardHorizontal
                                            ...
                                            image={videoExplicativo._embedded ? videoExplicativo._embedded['wp:featuredmedia'][0].media_details.sizes.thumbnail.source_url : ''}
